...
<head>
    ...
    <title>Minha Carteira - Cadastro de Usuário</title>
...
<body>
    ...
    <div class="containercad">
        <form id="formulario" action="cad-loginbd.php" method="POST" enctype="multipart/form-data">
            <div class="row-flex">
            ...
            <div class="row-flex">
                <div class="col">
                    ...
                    <select name="nivel" id="nivel">
                        <option value="" <?php echo ($selectedNivel == '') ? 'selected' : ''; ?>>Selecione</option>
                        <option value="Usuário" <?php echo ($selectedNivel == 'Usuário') ? 'selected' : ''; ?>>Usuário</option>
                        <option value="Administrador" <?php echo ($selectedNivel == 'Administrador') ? 'selected' : ''; ?>>Administrador</option>
                        <?php if (isset($novaCategoria)) : ?>
                            <option value="<?php echo $novaCategoria; ?>" selected><?php echo $novaCategoria; ?></option>
                        <?php endif; ?>
                    </select>
                    <div class="mensagem-erro" style="color: red;"></div>
                </div>
                ...
                <div class="col">
                    ...
                    <select name="status" id="status">
                        <option value="" <?php echo ($selectedStatus == '') ? 'selected' : ''; ?>>Selecione</option>
                        <option value="Desativado" <?php echo ($selectedStatus == 'Desativado') ? 'selected' : ''; ?>>Desativado</option>
                        <option value="Ativado" <?php echo ($selectedStatus == 'Ativado') ? 'selected' : ''; ?>>Ativado</option>
                    </select>
                    <div class="mensagem-erro" style="color: red;"></div>
                </div>
            </div>
