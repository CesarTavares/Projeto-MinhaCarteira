...
$sql_lancamentos = "SELECT des.descricao, valor, data_pagamento, data_vencimento, cat.descricao as descricao_categoria, car.descricao as descricao_carteira, situacao
                              ...
                              WHERE data_vencimento BETWEEN :data_inicio AND :data_final
...
$dados .= "<title>Minha Carteira - Relatorio de Lançamentos</title>";
$dados .= "</head>";
$dados .= "<style>
.header h1 {
    text-align: center;
...
$dados .= "<h1>Relatório de Lançamentos de Despesa por Data</h1>";
$dados .= "</div>";
