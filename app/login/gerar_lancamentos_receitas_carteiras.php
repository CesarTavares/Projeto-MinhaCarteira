...
$sql_lancamentos_car = "SELECT des.descricao, valor, data_credito, cat.descricao as descricao_categoria, car.descricao as descricao_carteira, situacao
                              ...
                              WHERE des.carteira = :carteira AND data_credito BETWEEN :data_inicio AND :data_final";
//preparar a QUERY
...
$dados .= "<title>Minha Carteira - Relatorio de Lançamentos de Receitas por Carteiras</title>";
$dados .= "</head>";
...
$dados .= "<h1> Relatorio de Lançamentos de Receitas por Carteiras</h1>";
$dados .= "</div>";
