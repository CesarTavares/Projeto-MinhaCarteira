...
<body>
        <h1 class="titulo-2">Relatório de Lançamentos por Categorias</h1>
        ...
        if ($result_lancamentos->rowCount() != 0) {  
            ...
            while ($row_lancamento = $result_lancamentos->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "<tr>
                        ...
                        $total += $row_lancamento['valor'];   
                    }

                    echo "<tr> 
                    <td colspan='6' style='text-align: right;'><strong>Saldo Total:</strong></td>
