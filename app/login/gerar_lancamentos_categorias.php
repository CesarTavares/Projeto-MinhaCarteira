...
if ($lancamentos_categoria && $data_inicio && $data_final && validarData($data_inicio) && validarData($data_final)) {
    try {       
        ...
        $sql_lancamentos_cat = "SELECT des.descricao, valor, data_pagamento, data_vencimento, cat.descricao as descricao_categoria, car.descricao as descricao_carteira, situacao
                                    ...
                                    WHERE des.categoria = :categoria  AND data_vencimento BETWEEN :data_inicio AND :data_final";
        //preparar a QUERY
        ...
        $dados .= "<title>Minha Carteira - Relatorio de Lançamentos por Categorias</title>";
        $dados .= "</head>";
        ...
        $dados .= "<h1>Relatorio de Lançamentos por Categorias</h1>";
        $dados .= "</div>";
